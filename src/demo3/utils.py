...
def plot2dlayers(arr, xlabel=None, ylabel=None, title=None, cmap=None, colorbar=True, win=None, figsize=(6.4, 4.8)):
    """
    ...
    """
    plt.figure(figsize=figsize) # default is [6.4, 4.8] print(plt.rcParams["figure.figsize"])
    if xlabel is None:
        xlabel=''
    if ylabel is None:
        ylabel=''
    ...
    if win is None:
        ...
        plt.imshow(arr, cmap=cmap, interpolation="nearest", vmin=win[0], vmax=win[1])
    cb = plt.colorbar()
